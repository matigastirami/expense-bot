...
from src.db.crud import AccountBalanceCRUD, PendingTransactionCRUD, TransactionCRUD
from src.db.models import PendingTransaction, TransactionType
...
class PendingTransactionProcessor:
    ...
    async def _get_converted_amount(self, session, account_id: int, 
        ...
        from src.db.models import AccountBalance
