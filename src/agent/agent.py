...
class FinanceAgent:
        ...
        try:
            if intent.intent == QueryIntent.BALANCE:
                ...
                if largest:
                    ...
                    response = f"💸 **Mayor gasto {date_str}:**\n"
                    ...
                    if largest.description:
                        response += f"**Descripción:** {largest.description}\n"
    ...
    def _format_monthly_report(self, report: MonthlyReport) -> str:
        ...
        lines = [
            f"📊 **Monthly Report - {report.month:02d}/{report.year}**",
            "",
